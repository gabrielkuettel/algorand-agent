...
export const name = 'mcp__app_call'
...
export const schema = z.object({
  ...
  appArgs: z
    ...
    .optional()
    .describe(
      'Arguments for the application call. String handling: 1) For ASCII strings, pass directly: "Hello" 2) For reliable encoding, use base64: "SGVsbG8=" (base64 for "Hello") 3) For numeric values, pass as strings: "123"'
    ),
  onComplete: z
